...
tmux split-window -f -v -t tp:0 'sleep 1.5 && exec ./vexec consola ./PLANI_1 50'
tmux split-window -h -t tp 'sleep 2.0 && exec ./vexec consola ./PLANI_1 50'
tmux split-window -h -t tp 'sleep 2.5 && exec ./vexec consola ./PLANI_2 50'
